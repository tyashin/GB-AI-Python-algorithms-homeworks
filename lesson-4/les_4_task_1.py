...
# Вариант №3 (используем два list comprehension вместо цикла "for"):
N = 100
...
# Временная сложность всех трех алгоритмов составляет O(n).


# Примечание. В ходе решения задачи испробован альтернативный способ определения четности: "not a[i] & 1" (проверка на 0 в последнем бите числа).
# Этот способ оказался немного более медленным, чем проверка остатка от деления на 2.
